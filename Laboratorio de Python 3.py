...
#   nombre;str la variale nombre es un str
#=========================================
...
muchos_saludos("Bosco","Angel","David","Tamara","Mili","Edwin","Lev","Luis","Luis","Abigail")
...
greet(firstname='Bill', lastname='Gates', age=55) # Se pueden pasar más párámetros de los necesarios
