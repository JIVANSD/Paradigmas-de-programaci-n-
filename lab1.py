...
# Mensaje a pantalla
#====================
print ("Este es un comande de python. ", "Este es otro enunciado.", t)
print('id: ', 1)
...
print(matriz) 
#====================================================================
# Indentación estrcita para procesos dependientes de  : (dos puntos)
#====================================================================
if 10>5:
...
if 10>5:
    ...
    if 10<20:
        print("verdadero")
elif 5>3:  #comienza la segunda condicional
